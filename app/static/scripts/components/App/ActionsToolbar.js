...
const ActionsToolbar = () => {
    return (
        <div className="btn-toolbar d-flex justify-content-center m-3" role="toolbar">
            <div className="btn-group me-2 btn-group-lg" role="group">
                ...
                <button type="button" className="btn btn-outline-secondary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-justify-right" viewBox="0 0 16 16">
